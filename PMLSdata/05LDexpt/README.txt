...
LDexpt23.csv, LDexpt22.csv, LDexpt23.npy and LDexpt22.npy:
Same data with bins in the first column and expcounts in the second column.

LDexpt.npz: Same data as LDexpt.mat

Data from Luria and Delbruck. Mutations of bacteria from virus sensitivity to
virus resistance. Genetics (1943) vol. 28 pp. 491--511, table 5 p505.
